...
static int r_particle_etc(struct SN_env * z) { /* backwardmode */
    int among_var;
    {   int m1 = z->l - z->c, mlimit1; (void)m1; /* setlimit, line 55 */
...
static int r_possessive(struct SN_env * z) { /* backwardmode */
    int among_var;
    {   int m1 = z->l - z->c, mlimit1; (void)m1; /* setlimit, line 69 */
        if (z->c < z->I[0]) return 0;
...
static int r_case_ending(struct SN_env * z) { /* backwardmode */
    int among_var;
    {   int m1 = z->l - z->c, mlimit1; (void)m1; /* setlimit, line 96 */
        if (z->c < z->I[0]) return 0;
...
static int r_other_endings(struct SN_env * z) { /* backwardmode */
    int among_var;
    {   int m1 = z->l - z->c, mlimit1; (void)m1; /* setlimit, line 142 */
...
static int r_i_plural(struct SN_env * z) { /* backwardmode */
    {   int m1 = z->l - z->c, mlimit1; (void)m1; /* setlimit, line 154 */
        if (z->c < z->I[0]) return 0;
...
static int r_t_plural(struct SN_env * z) { /* backwardmode */
    int among_var;
    {   int m1 = z->l - z->c, mlimit1; (void)m1; /* setlimit, line 161 */
        if (z->c < z->I[0]) return 0;
    ...
    {   int m3 = z->l - z->c, mlimit3; (void)m3; /* setlimit, line 165 */
        if (z->c < z->I[1]) return 0;
...
static int r_tidy(struct SN_env * z) { /* backwardmode */
    {   int m1 = z->l - z->c, mlimit1; (void)m1; /* setlimit, line 173 */
        if (z->c < z->I[0]) return 0;
